    ...
    <div class="gambleShow-header">
     ...
     <el-form-item label="训练轮次">
      ...
      <!-- <div class="mostBtn"> -->
        ...
        <el-upload  
          class="uploadTest"
          action="http://127.0.0.1:8001/api_gambling/gambling/uploadTestData/"
        ...
        <el-upload
          class="uploadTrain"
          action="http://127.0.0.1:8001/api_gambling/gambling/uploadTrainData/"
...
export default {
  ...
  methods: {
    download() {
      window.location.href = 'http://127.0.0.1:8001/api_gambling/gambling/downloadModel/'
    },
    ...
    // },
    init() {
      this.$store.dispatch('gambling/gambleModelInit').then(response => {
        this.showChartGamble()
        this.loading = true
        this.$store.dispatch('gambling/gambleTestInit').then(response => {
          this.gambleTestList = this.gambleTest_data['cardlist']
          this.loading = false
          this.showTextChart1()
          this.showTextChart2()
          this.showTextChart3()
    ...
    create() {
      this.$confirm('此操作将会运行模型并返回结果, 是否继续?', '提示', {
        ...
        this.$store.dispatch('gambling/gambleModelShow', this.form).then(response => {
          console.log('This is backData', this.gambleModel_data)
    ...
    testShow() {
      this.$confirm('此操作将会进行模型测试并返回结果, 是否继续?', '提示', {
        ...
        this.loading = true
        this.$store.dispatch('gambling/gambleTestShow').then(response => {
    ...
    showChartGamble() {
      ...
      var option = {
        ...
        xAxis: {
          ...
          data: this.gambleModel_data['epoch_list']
        },
        yAxis: {
          type: 'value',
          min: 'dataMin',
        ...
        series: [
          {
            ...
            data: this.gambleModel_data['auc_list']
          },
          {
            name: 'R',
            type: 'line',
            ...
            data: this.gambleModel_data['recall_list']
          },
          {
            name: 'F1',
            type: 'line',
            ...
            data: this.gambleModel_data['f1_list']
          }
        ]
      }
          ...
          elements: [
            {
              ...
              style: {
                // text: '0.1194',
                text: this.gambleModel_data['auc'],
                fontSize: 20,
                fontWeight: 'bold',
                // lineDash: [0, 200],
                // lineDashOffset: 0,
          ...
          elements: [
            {
              ...
              style: {
                // text: '0.8888',
                text: this.gambleModel_data['recall'],
                fontSize: 20,
                fontWeight: 'bold',
                // lineDash: [0, 200],
                // lineDashOffset: 0,
        ...
        series: [
          {
            ...
            data: this.gambleModel_data['pie']
          }
        ]
      }
